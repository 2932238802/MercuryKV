...
class KvTagAssociation
{
  public:
     ...
     */
    explicit KvTagAssociation(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit KvTagAssociation(const Json::Value &pJson) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<KvTagAssociation>;
    friend drogon::orm::BaseBuilder<KvTagAssociation, true, true>;
    friend drogon::orm::BaseBuilder<KvTagAssociation, true, false>;
    friend drogon::orm::BaseBuilder<KvTagAssociation, false, true>;
    friend drogon::orm::BaseBuilder<KvTagAssociation, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<KvTagAssociation>;
#endif
