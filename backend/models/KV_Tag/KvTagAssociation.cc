...
KvTagAssociation::KvTagAssociation(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
void KvTagAssociation::updateByMasqueradedJson(const Json::Value &pJson,
...
bool KvTagAssociation::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool KvTagAssociation::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                        const std::vector<std::string> &pMasqueradingVector,
                                                        std::string &err)
{
    if(pMasqueradingVector.size() != 2)
