...
const std::vector<typename Users::MetaData> Users::metaData_ = {
    ...
    {"salt", "std::string", "character varying", 64, 0, 0, 1},
    {"created_at", "::trantor::Date", "timestamp with time zone", 0, 0, 0, 1},
    {"last_login_at", "::trantor::Date", "timestamp with time zone", 0, 0, 0,
     0}};
...
Json::Value Users::toMasqueradedJson(
  ...
  if (pMasqueradingVector.size() == 7) {
    ...
    if (!pMasqueradingVector[6].empty()) {
      if (getLastLoginAt()) {
        ret[pMasqueradingVector[6]] = getLastLoginAt()->toDbStringLocal();
      } else {
...
bool Users::validateJsonForCreation(const Json::Value &pJson,
  ...
  if (pJson.isMember("last_login_at")) {
    if (!validJsonOfField(6, "last_login_at", pJson["last_login_at"], err,
                          true))
      return false;
  }
  return true;
