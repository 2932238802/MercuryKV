    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 6)
    {
        ...
        if(!pMasqueradingVector[5].empty())
        {
            if(getLastLoginAt())
            {
                ret[pMasqueradingVector[5]]=getLastLoginAt()->toDbStringLocal();
            }
            else
            {
...
bool Users::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("last_login_at"))
    {
        if(!validJsonOfField(5, "last_login_at", pJson["last_login_at"], err, true))
            return false;
    }
    return true;
}
...
bool Users::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("last_login_at"))
    {
        if(!validJsonOfField(5, "last_login_at", pJson["last_login_at"], err, false))
            return false;
    }
    return true;
}
